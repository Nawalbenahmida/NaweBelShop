...
ShoppUI::addmetabox('customer-billing', Shopp::__('Adresse de facturation') . $Admin->boxhelp('customer-editor-billing'), 'billing_meta_box', 'shopp_page_shopp-customers', 'normal', 'core');
