...
ShoppUI::addmetabox('order-billing', Shopp::__('Adresse de facturation') . $Admin->boxhelp('order-manager-billing'), 'billto_meta_box', 'toplevel_page_shopp-orders', 'side', 'core');
