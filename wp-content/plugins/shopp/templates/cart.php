...
<?php if ( shopp( 'cart.hasitems' ) ) : ?>
	<form id="cart" action="<?php shopp( 'cart.url' ); ?>" method="post">
		<div>
			<a href="<?php shopp( 'cart.referrer' ); ?>">&laquo; <?php Shopp::_e( 'Continuer vos achats' ); ?></a>
			<a href="<?php shopp( 'checkout.url' ); ?>" class="right"><?php Shopp::_e( 'Passer à la caisse' ); ?> &raquo;</a>
		</div>
		...
		<table class="cart">
			<tr>
				<th scope="col" class="item"><?php Shopp::_e( 'PANIER DES ARTICLES' ); ?></th>
				<th scope="col"><?php Shopp::_e( 'Quantité' ); ?></th>
				<th scope="col" class="money"><?php Shopp::_e( 'PRIX DE L&apos;ARTICLE' ); ?></th>
				<th scope="col" class="money"><?php Shopp::_e( 'Objet total' ); ?></th>
			</tr>
			...
			<tr class="totals">
				...
				<th scope="row"><?php Shopp::_e( 'Sous-total' ); ?></th>
				<td class="money"><?php shopp( 'cart.subtotal' ); ?></td>
			</tr>

			<?php if ( shopp( 'cart.hasdiscount' ) ) : ?>
				<tr class="totals">
					<th scope="row"><?php Shopp::_e( 'Remise' ); ?></th>
			...
			<?php if ( shopp( 'cart.needs-shipped' ) ) : ?>
				<tr class="totals">
					<th scope="row"><?php shopp( 'cart.shipping', 'label=' . Shopp::__( 'FRAIS DE LIVRAISON ' ) ); ?></th>
					<td class="money"><?php shopp( 'cart.shipping' ); ?></td>
				</tr>
			<?php endif; ?>

			<tr class="totals">
				<th scope="row"><?php shopp( 'cart.tax', 'label=' . Shopp::__( 'Taxe' ) ); ?></th>
...
<?php else : ?>
	...
	<p>
		<a href="<?php shopp( 'storefront.url' ); ?>">&laquo; <?php Shopp::_e( 'Continuer vos achats' ); ?></a>
	</p>
<?php endif; ?>
